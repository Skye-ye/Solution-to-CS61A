...
class Player:
    def __init__(self, deck, name):
        ...
        initial_cards = []
        for _ in range(5):
            initial_cards.append(self.deck.draw())
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        other_attack = other_card.attack
        other_defense = other_card.defense
        ...
        opponent.deck.cards = [card for card in opponent.deck.cards 
            if card.attack != other_attack and card.defense != other_defense]
